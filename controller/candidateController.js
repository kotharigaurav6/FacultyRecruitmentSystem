...
export const candidateRegistrationController = async(request,response)=>{
  ...
  filename.mv(pathName,async (error)=>{
    if(error){
        ...
        var mailContent = "Hello "+email+",<br>Welcome to Programming Stairs. It's a <b>Verification Mail</b> from <b>Programming Stairs</b>.<br><br>Please Click on the below <b>Link</b> to Verify.<br> <a href='https://facultyrecruitmentsystem.onrender.com/candidate/verifyemail?email="+email+"'>Click Here to Verify</a>";
